...
#se make sure that you have below listed libraries pre installed on your system
   # * Matplotlib
   # * Gym
   # * Box2D
    #* Swig (If Prompted)
...
class Agent():
    ...
    def learn(self):
        ...
        self.epsilon = self.epsilon - self.epsDecay if self.epsilon > self.epsMin             else self.epsMin
